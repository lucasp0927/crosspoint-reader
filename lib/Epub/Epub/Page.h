...
class Page {
 public:
  ...
  // `renderer` supplies the vertical-mode mapping (null = horizontal layout).
  bool getImageBoundingBox(int16_t& outX, int16_t& outY, int16_t& outW, int16_t& outH,
                           const GfxRenderer* renderer = nullptr) const;
};
